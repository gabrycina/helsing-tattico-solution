...
class Simulator:
    ...
    def start_simulation(self):
        ...
        try:
            ...
            with grpc.insecure_channel(self.server_address) as channel:
                ...
                logger.info(f"Base position: ({self.base_position[0]}, {self.base_position[1]})")
    ...
    def run(self, strike_delay=5.0):
        ...
        if strike_delay > 0:
            logger.info(f"Sensors activated. Waiting {strike_delay} seconds before launching strike unit...")
