...
class SensorUnit:
    ...
    def __init__(
        ...
        idx = int(unit_id) - 1
        self.sub_patrols = [(5, 5), (-5, 5), (-5, -5), (5, -5)]
        self.sub_patrol_idx = 0
        self.patrol_position = (
            patrol_positions[idx][0] + self.sub_patrols[self.sub_patrol_idx][0],
            patrol_positions[idx][1] + self.sub_patrols[self.sub_patrol_idx][1],
        )
        self.navigator.set_target(
            self.patrol_position + self.sub_patrols[self.sub_patrol_idx]
        )
